    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (ch == 1) {
                ...
                System.out.println("카테고리 코드를 입력하세요"); int cateCode=scan.nextInt();
                System.out.println("제품명을 입력하세요"); String name=scan.next();
                System.out.println("제품가격을 입력하세요"); int price=scan.nextInt();
